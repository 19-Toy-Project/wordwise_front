...
#### 메인페이지
![Image](https://github.com/user-attachments/assets/ed3f64d6-6f78-4ddf-9fa8-87ba45b7d27a)
- 카카오 소셜 로그인
- 로그아웃

#### 마이페이지
![Image](https://github.com/user-attachments/assets/9a56d876-5cad-414a-b38f-9cd49fc65f7c)
- 개인 프로필 조회
- 학습 레벨별 평균 점수 조회
- 찜한 문장 조회
  
#### 학습페이지
![Image](https://github.com/user-attachments/assets/19e61089-cc3e-44eb-8040-0cfe3e876030)
- 영어 단어 전체 조회
- 영어 단어 상세 조회
- 영어 문장 녹음
- 영어 문장 찜 & 해제
...
## 프로젝트 후기
#### 강수민
OAuth 2.0을 활용하여 소셜 로그인의 기능을 구현하였고, JWT를 적용해 인증과 인가를 강화하였습니다. 특히, Refresh Token을 활용한 토큰 재발급 기능을 추가하여 보안성을 높히는 경험을 가질 수 있었습니다. 사용자의 경험을 고려한 UI 최적화를 위해 응답 속도를 개선 시킬 수 있는 데이터 최적화가 미흡하다고 느껴 개선 중 입니다.
앞으로는 보안성과 성능을 더욱 강화하고, 코드의 가독성과 유지보수성을 높이는 방향으로 발전시키고 싶습니다. 지속적인 개선과 학습을 통해 더욱 완성도 높은 서비스를 개발하는 것이 목표입니다.
#### 정지윤
